...
from rollbar.lib import defaultJSONEncode, dict_merge, events, filters, transport
...
from rollbar.lib import transforms, type_info
...
def _send_payload_httpx(payload_str, access_token):
    from rollbar.lib._async import _post_api_httpx, call_later
    try:
